...
$(document).ready(function($) {
    ...
    var latitude = 35.668115;
    var longitude = 139.685635;
...
//  Parallax Background Image
    ...
    $(".ts-form-email .btn[type='submit']").on("click", function(e){
        ...
        $.validator.messages.required = 'å¿…é ˆé …ç›®ãŒæœªå…¥åŠ›ã§ã™';
        $form.validate({
...
// On SCROLL actions
    ...
    $('.slide-matbang .owl-carousel').owlCarousel({
        dots:false,
        navs:true
    });
    $(function() {                       
